...
class OrderedListResults(Benchmark):
    """
    Benchmark for the ordered list results task, where the results of `Config.operation` on a list of numbers are ordered in `Config.order`.
    ...
    class Config(Benchmark.Config):
        """The configuration of the ordered list results benchmark."""

        name: str = "OrderedListResults"
    ...
    def config_cls(self) -> type[Config]:
        return OrderedListResults.Config

    def __init__(self, config: Config):
        """
        Initialize the ordered list results benchmark.
        ...
        self._config: OrderedListResults.Config  # pyright is too dumb for this
    ...
    def build(
        ...
        """
        Build the ordered list results benchmark.
